...
/* \file
 *
 *  USB Device Descriptors, for library use when in USB device
 *  mode. Descriptors are special computer-readable structures which
 *  the host requests upon device enumeration, to determine the
